...
namespace FinalProMo3askar13102021.Areas.Administrator.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,Password,isActive,RoleId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,Password,isActive,RoleId")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
